...
export class UpdateMedicalRecordTreatmentUseCase {
    ...
    async execute(id: number, dto: UpdateMedicalRecordTreatmentDto): Promise<MedicalRecordTreatmentResponseDto> {
        ...
        if (dto.jumlah !== undefined || dto.hargaSatuan !== undefined || dto.diskon !== undefined) {
