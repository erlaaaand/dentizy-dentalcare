...
export class MedicalRecordEventListener {
    ...
    async handleMedicalRecordCreated(event: MedicalRecordCreatedEvent): Promise<void> {
        this.logger.log(
    ...
    async handleMedicalRecordUpdated(event: MedicalRecordUpdatedEvent): Promise<void> {
        this.logger.log(
            `✏️ ${event.getDescription()}`
        );
    ...
    async handleMedicalRecordDeleted(event: MedicalRecordDeletedEvent): Promise<void> {
     ...
     * Send notification to relevant parties
     */
    private async sendNotification(event: MedicalRecordCreatedEvent): Promise<void> {
     ...
     * Send update notification
     */
    private async sendUpdateNotification(event: MedicalRecordUpdatedEvent): Promise<void> {
     ...
     * Send deletion notification
     */
    private async sendDeletionNotification(event: MedicalRecordDeletedEvent): Promise<void> {
        // TODO: Implement notification service
        this.logger.debug(
     ...
     */
    private async updateDeletionStatistics(event: MedicalRecordDeletedEvent): Promise<void> {
     ...
     */
    private async triggerIntegrations(event: MedicalRecordCreatedEvent): Promise<void> {
     ...
     */
    private async handleRecordCompleted(event: MedicalRecordUpdatedEvent): Promise<void> {
     ...
     */
    private async invalidateCache(event: MedicalRecordUpdatedEvent): Promise<void> {
     ...
     */
    private async clearCacheForDeletedRecord(event: MedicalRecordDeletedEvent): Promise<void> {
     ...
     */
    private async archiveBeforePermanentDeletion(event: MedicalRecordDeletedEvent): Promise<void> {
