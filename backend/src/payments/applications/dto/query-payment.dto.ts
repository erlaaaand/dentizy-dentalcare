...
import { IsOptional, IsInt, IsEnum, IsDateString, Min, IsString } from 'class-validator';
...
export class QueryPaymentDto {
    ...
    @ApiPropertyOptional({ description: 'Jumlah data per halaman', default: 10, minimum: 1 })
    @IsOptional()
    @IsInt()
    @Min(1)
    @Type(() => Number)
