...
@ApiForbiddenResponse({ description: 'Role user tidak memiliki akses ke endpoint ini' }) // Fix syntax missing '@'
...
export class TreatmentsController {
    ...
    async create(@Body() createDto: CreateTreatmentDto): Promise<TreatmentResponseDto> {
    ...
    async findAll(@Query() query: QueryTreatmentDto): Promise<PaginatedTreatmentResponseDto> {
    ...
    async findOne(@Param('id', ParseIntPipe) id: number): Promise<TreatmentResponseDto> {
    ...
    async restore(@Param('id', ParseIntPipe) id: number): Promise<TreatmentResponseDto> {
    ...
    async activate(@Param('id', ParseIntPipe) id: number): Promise<TreatmentResponseDto> {
    ...
    async deactivate(@Param('id', ParseIntPipe) id: number): Promise<TreatmentResponseDto> {
