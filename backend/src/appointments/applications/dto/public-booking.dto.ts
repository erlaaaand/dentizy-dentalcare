...
export class PublicBookingDto {
    ...
    @ApiProperty({ description: 'Tanggal Lahir (YYYY-MM-DD)', example: '1990-01-01' })
    @IsDateString()
    ...
    @ApiPropertyOptional({ description: 'Email (Opsional)', example: 'budi@example.com' })
    @IsOptional()
    @IsString()
    email?: string;
    ...
    @ApiProperty({ description: 'Tanggal Janji (YYYY-MM-DD)', example: '2025-11-20' })
    @IsDateString()
