...
describe('AppointmentCreationService', () => {
    ...
    beforeEach(async () => {
        ...
        const module: TestingModule = await Test.createTestingModule({
            providers: [
                ...
                { provide: AppointmentConflictValidator, useValue: mockConflictValidator },
    ...
    describe('execute', () => {
        it('should successfully create an appointment and emit event', async () => {
            ...
            mockRepository.findPatientByIdInTransaction.mockResolvedValue(mockPatient as any);
            mockRepository.findDoctorByIdInTransaction.mockResolvedValue(mockDoctor as any);
            mockDomainService.createAppointmentEntity.mockReturnValue(mockAppointment);
            ...
            expect(mockCreateValidator.validateCreateAppointment).toHaveBeenCalledWith(
                mockPatient,
                mockCreateAppointmentDto.patient_id,
                mockDoctor,
                mockCreateAppointmentDto.doctor_id
        ...
        it('should throw NotFoundException and rollback when patient not found', async () => {
            ...
            // Act & Assert
            await expect(service.execute(mockCreateAppointmentDto)).rejects.toThrow(expectedError);
