...
export function Toast({
    ...
    const getVariantClasses = () => {
        switch (variant) {
            ...
            case 'outlined':
                return toastType.outlined;
            default:
                return toastType.base;
        }
    };
    ...
    return (
        ...
        >
            ...
            <div className="flex-1 min-w-0">
                <p className={cn('font-medium', sizeClass.message)}>
                    {message}
                </p>
                    ...
                    <div className="mt-2">
                        <button
                            ...
                            className={cn(
                                ...
                                variant === 'filled' ? 'text-white/90 hover:text-white' : 'hover:text-opacity-80'
                            )}
                        >
                            {action.label}
                        </button>
