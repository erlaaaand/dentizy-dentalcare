// frontend/src/components/landing/contact-section/ContactSection.tsx
'use client';

import React, { useMemo, useState } from 'react';
import { CalendarIcon, MapPinIcon, PhoneIcon, ClockIcon, MessageIcon } from '../shared/Icons';
            ...
            <div className="container mx-auto px-6 relative z-10">
                ...
                <div className="grid md:grid-cols-12 gap-12 max-w-7xl mx-auto">
                    ...
                    <div className="md:col-span-4 space-y-6">
                        <h3 className="text-2xl font-bold text-blue-400">Informasi Klinik</h3>
                        ...
                        <form onSubmit={handleSubmit} className="space-y-6">
                            ...
                            <FormSection title="2. Rencana Kunjungan">
                                <FormSelect
                                    ...
                                    onChange={handleChange}
                                    options={[
                                        { value: '', label: '-- Pilih Dokter & Layanan --' },
                                        ...AVAILABLE_DOCTORS.map(doc => ({
                                            value: doc.id,
                                            label: doc.nama_lengkap || doc.username
                                        }))
                                    ]}
                                    required
                                />
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                    ...
                                    <div>
                                        <FormInput
                                            ...
                                            required
                                        />
                                        <p className="text-xs text-gray-400 mt-1">Jam Praktik: 09:00 - 21:00</p>
                                    </div>
                                </div>
...
function InfoItem({ icon, title, content, gradientFrom, gradientTo }: any) {
    return (
        <div className="flex items-start space-x-4">
            <div className={`w-10 h-10 bg-gradient-to-br ${gradientFrom} ${gradientTo} rounded-full flex items-center justify-center flex-shrink-0`}>
                {icon}
            </div>
            <div>
        ...
        <div>
            ...
            >
                {options.map((opt: any, i: number) => (
                    <option key={i} value={opt.value} className="bg-gray-800">
                        {opt.label}
                    </option>
                ))}
            </select>
