...
import {
  PublicBookingDto,
} from "../../../core/api/model/publicBookingDto";

import {
  PublicBookingDtoJenisKelamin,
} from "../../../core/api/model/publicBookingDtoJenisKelamin";

// import { useToast } from "@/core";

// Hooks
import { usePublicAppointmentsControllerBook } from "../../../core/api/generated/public-appointments/public-appointments";
...
export function ContactSection() {
  ...
  const { mutate: bookAppointment, isPending } = usePublicAppointmentsControllerBook();
  // const { showSuccess, showError } = useToast();

  const AVAILABLE_DOCTORS = useMemo<DoctorItem[]>(() => {
    const doctors = doctorsData?.data as DoctorItem[] | undefined;
    return (
      doctors?.map((d) => ({
        id: d.id,
        nama_lengkap: d.nama_lengkap ?? undefined,
